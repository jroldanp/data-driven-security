# This is to generate a wew temporary files to allocate feed data.
...
# formatted we skip 10 first rows where there is no tabulated data, we set # header as FALSE since there is no header with fileds and we define them
